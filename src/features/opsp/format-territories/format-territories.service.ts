...
@Injectable()
export class FormatTerritoriesService {
  constructor(
    @InjectRepository(FormatTerritory)
    private readonly repo: Repository<FormatTerritory>,
  ) {}

  async create(dto: CreateFormatTerritoryDto) {
    try {
  ...
  async update(id: number, dto: UpdateFormatTerritoryDto) {
    try {
