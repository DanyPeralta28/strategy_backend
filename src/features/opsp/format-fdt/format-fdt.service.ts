...
@Injectable()
export class FormatFdtService {
  constructor(
    @InjectRepository(FormatFdt)
    private readonly repo: Repository<FormatFdt>,
  ) {}

  async create(dto: CreateFormatFdtDto) {
    try {
  ...
  async update(id: number, dto: UpdateFormatFdtDto) {
    try {
