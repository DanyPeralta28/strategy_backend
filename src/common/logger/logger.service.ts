...
import winston, { format, createLogger, Logger, transports } from 'winston';
...
export class LoggerService {
    ...
    createLoggers(){
        ...
        // Logger general
        this.loggerAssert = createLogger({
            level: 'info',
    ...
    replaceConsole(){
        ...
        // console.ok
        console.assert = (message: any, params: any) => {
            if(params){
                this.loggerAssert.info(message + " " + JSON.stringify(params));
                this.loggerAll.info(message + " " + JSON.stringify(params));
            }else{
                this.loggerAssert.info(message);
                this.loggerAll.info(message);
            }
        }
